...
```{r figure_7_A}
#Load GWAS results ####
tcga <- read.delim("../../data/figure_7/tcga_brca_cnv_csj_genome_wide_association.tsv")
...
# ggsave(filename = "TCGA_BRCA_Manhattan.pdf",
#        height = 8, width = 16)
```
...
```{r figure_7_b}
#Load TCGA CNV data
load("../../data/figure_7/tcga_brca_cnv.RData")

# Load recount data junction score ####
usage <- read.csv("../../data/figure_7/tcga_brca_csj_usage.csv",
                  row.names = 1)
ki_counts <- read.csv("../../data/figure_7/tcga_brca_known_intron_counts.csv",
                      row.names = 1)
metadata <- read.csv("../../data/figure_7/tcga_brca_metadata.csv")
